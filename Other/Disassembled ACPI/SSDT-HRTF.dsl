// SSDT for T480 HPET, RTC amd TIMR 3 in 1 fixup
//
...
DefinitionBlock ("", "SSDT", 2, "T480", "HRTF", 0)
{
...
//    }
    ...
    Scope (\_SB.PCI0.LPCB)
    {
        ...
        Device (HPE0)
        {
            ...
            {
                CreateDWordField (BUF0, \_SB.PCI0.LPCB.HPE0._Y24._BAS, HPT0)  // _BAS: Base Address
                HPT0 = \HPET
                Return (BUF0) /* \_SB_.PCI0.LPCB_.HPE0.BUF0 */
            }
        }
